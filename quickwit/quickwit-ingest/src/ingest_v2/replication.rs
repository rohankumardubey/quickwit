...
use crate::{
    syn_replication_message, AckReplicationMessage, CommitType, IngestErrorV2, ReplicateRequest,
    ReplicateResponse, ReplicateSuccess, ShardState, SynReplicationMessage, TruncateRequest,
    TruncateResponse,
};
    ...
    async fn run(&mut self) {
            ...
            self.oneshot_replication_request_rx.recv().await
        {
            ...
            let ack_replication_message = self
                ...
                .expect("FIXME")
                .expect("FIXME");
            let replication_response = ack_replication_message
                .into_replication_response()
                .expect("");
