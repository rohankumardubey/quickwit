...
impl TypedSourceFactory for KafkaSourceFactory {
    ...
    async fn typed_create_source(
        ...
        KafkaSource::try_new(runtime_args, params, checkpoint).await
    }
}
...
mod kafka_broker_tests {
    ...
    async fn test_kafka_source_process_message() {
        ...
        let mut kafka_source = KafkaSource::try_new(runtime_args, params, ignored_checkpoint)
            .await
            .unwrap();
    ...
    async fn test_kafka_source() -> anyhow::Result<()> {
        ...
        let source_loader = quickwit_supported_sources();
        {
            ...
            let source = source_loader
                .load_source(runtime_args, SourceCheckpoint::default())
                .await?;
