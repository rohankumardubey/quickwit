...
use quickwit_proto::search::{
    FetchDocsResponse, PartialHit, SearchRequest, SplitIdAndFooterOffsets,
};
use quickwit_proto::{
    FetchDocsResponse, PartialHit, PartialHit, SearchRequest, SnippetRequest,
    SplitIdAndFooterOffsets, SplitIdAndFooterOffsets,
};
